            ...
            <div className="mt-8 flex items-center justify-center md:justify-start space-x-6">
              <div className="flex -space-x-2">
                <img
                  ...
                  src="https://storage.googleapis.com/queens-videos/Reviewers/Aleksanadra%20Blaszczyk.webp"
                  alt="Aleksandra Blaszczyk"
                />
                <img
                  className="w-10 h-10 rounded-full border-2 border-slate-700 animate-on-scroll fade-up delay-3"
                  src="https://storage.googleapis.com/queens-videos/Reviewers/Ana%20Marie%20De%20La%20Cruz.webp"
                  alt="Ana Marie De La Cruz"
                />
                <img
                  className="w-10 h-10 rounded-full border-2 border-slate-700 animate-on-scroll fade-up delay-4"
                  src="https://storage.googleapis.com/queens-videos/Reviewers/Andres%20Rivera.webp"
                  alt="Andres Rivera"
                />
              </div>
              <p
